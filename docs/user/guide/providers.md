...
This guide assumes you started the Web UI through the [root README](../../../README.md#run-the-web-ui). Model changes take effect on the next request without restarting the server.
