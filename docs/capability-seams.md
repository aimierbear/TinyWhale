...
| `ctx.verifier` | `seam` | [`verifier`](../packages/verifier/verifier) | [`verifier-conversation`](../packages/verifier/verifier-conversation) | [`tool-verifier`](../packages/verifier/tool-verifier) | - | Providers register into ctx.verifier; tool-verifier owns the model-facing verify tool. |
