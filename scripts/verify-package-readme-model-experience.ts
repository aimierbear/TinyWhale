...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-update': { kind: 'none', reason: 'Browser-side Settings action over a Host git checkout; registers nothing model-facing.' },
  ...
  'packages/bundle/tinywhale': { kind: 'indirect', reason: 'The extras bundle is a patch-list carrier; each inserted row\'s package owns its model-facing behavior.' },
  ...
  'packages/verifier/verifier': { kind: 'indirect', reason: 'The provider registry delegates model rendering to dsh-verifier-conversation and dsh-tool-verifier.' },
}
