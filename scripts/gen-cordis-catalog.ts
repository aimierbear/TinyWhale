...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PairwiseScore: 'verifier.md',
  VerifierCallEventData: 'verifier.md',
  VerifierCandidate: 'verifier.md',
  VerifierCompareRequest: 'verifier.md',
  VerifierCompareResult: 'verifier.md',
  VerifierContext: 'verifier.md',
  VerifierCriterion: 'verifier.md',
  VerifierError: 'verifier.md',
  VerifierPairsRequest: 'verifier.md',
  VerifierProvider: 'verifier.md',
  VerifierRuntimeConfig: 'verifier.md',
  VerifierSelectRequest: 'verifier.md',
  VerifierSelectResult: 'verifier.md',
