...
- **Non-overlay conflicts and dirty trees stop the button** — apply never stashes and never force-resets. Overlay paths stay ours. README/LICENSE/index take upstream then rebrand. Any other conflict still aborts.
