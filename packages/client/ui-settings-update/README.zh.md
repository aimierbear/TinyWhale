...
- **非 overlay 冲突与脏工作区会拦住按钮** — apply 不会 stash、不会强制 reset。overlay 路径保持本 fork 版本。README / LICENSE / index 取上游再套品牌。其余冲突仍会中止。
