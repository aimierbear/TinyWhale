  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        returns: 'the settled execution (result + lifecycle pairing id), an admission success for a still-running background thenable, or `undefined` when syntax or name does not resolve.',
      },
    ],
  },
  {
