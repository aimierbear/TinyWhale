/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-tinywhale`.
 * @module @deepseek-ai/dsh-tinywhale/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-tinywhale'

/** Cordis companion plugin name. */
export const name = 'tinywhale-bundle-invariant'
